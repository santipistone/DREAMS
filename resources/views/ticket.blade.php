            ...
            <div class="miniContainerPos">
                <div id="list-box" class="list-box">
                    ...
                    <ul id="ticket-list" class="ticket-list" role="listbox" aria-labelledby="list-title">
                        ...
                        @if ($ticket['open'] == 1) 
                        <a style="text-decoration: none; color: black;" href="/ticket/{{(string)$ticket['id']}}" ><li  id="ticket1" class="ticket" role="listitem" aria-selected="true">{{$ticket['title']}}<p style="color: green;" class="sender">Open</p></li></a>
                        
                        @else
                        <a style="text-decoration: none; color: black;" href="/ticket/{{(string)$ticket['id']}}" ><li  id="ticket1" class="ticket" role="listitem" aria-selected="true">{{$ticket['title']}}<p style="color: red;" class="sender">Closed</p></li></a>
